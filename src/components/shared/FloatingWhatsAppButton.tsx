  ...
  return (
    <div className="hidden md:block fixed bottom-6 left-6 z-50">
      ...
      <motion.a
        ...
        onClick={() => trackAnalyticsEvent("whatsapp_click", { contact_method: "whatsapp", cta_location: "floating_button", page_type: pageType })}
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ delay: 1.2, type: "spring", stiffness: 300 }}
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        className="relative w-14 h-14 bg-[#25D366] rounded-full shadow-lg shadow-green-500/40 flex items-center justify-center hover:shadow-green-500/60 transition-shadow"
      >
