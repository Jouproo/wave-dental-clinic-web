        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.06 }}
              whileTap={{ scale: 0.96 }}
              className="flex items-center justify-center gap-2 bg-gradient-to-l from-teal-500 to-cyan-500 text-white font-semibold px-8 py-4 rounded-xl shadow-lg shadow-teal-900/30 hover:shadow-teal-900/50 transition-shadow"
            >
